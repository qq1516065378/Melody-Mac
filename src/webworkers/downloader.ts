...
import { resolveMediaFilePath } from "@/common/download-file-util";
...
async function downloadFile(
    ...
    try {
        ...
        filePath = resolveMediaFilePath(filePath, res);
...
interface IOptions {
    ...
    onEnded?: (filePath: string) => Promise<void>;
