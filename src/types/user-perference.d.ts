declare namespace IUserPreference {
  interface IType {
    ...
    speed: number;
    /** 均衡器与音效 */
    audioEffects: import("@renderer/core/track-player/audio-effects").IAudioEffectSettings;
    /** 两个用户自定义音效槽位 */
    audioEffectCustomPresets: Array<import("@renderer/core/track-player/audio-effects").IAudioEffectSettings | null>;
    /** 订阅 */
    subscription: Array<{
      title?: string;
      srcUrl: string;
