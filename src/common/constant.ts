...
export enum ResourceName {
    ...
    LOGO_IMAGE = "melody-icon-v3.png",
    TRAY_TEMPLATE_IMAGE = "trayTemplate-v5.png",
...
export const appUpdateSources = [
    "https://raw.githubusercontent.com/qq1516065378/Melody-Mac/master/release/version.json",
    "https://cdn.jsdelivr.net/gh/qq1516065378/Melody-Mac@master/release/version.json",
];
